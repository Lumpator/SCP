...
namespace SCPFileTransferApp.Services
{
    public class SftpService
    {
        ...
        public async Task UploadFileAsync(string localFilePath, string remoteDirectoryPath,
            Action<double> progressCallback)
        {
            using (var fileStream = File.OpenRead(localFilePath))
            {
                ...
                IAsyncResult asyncResult = sftpClient.BeginUploadFile(fileStream,
                    remoteDirectoryPath + "/" + Path.GetFileName(localFilePath), (result) =>
                    {
                        try
                        {
        ...
        public async Task DownloadFileAsync(string remoteFilePath, string localDirectoryPath,
            Action<double> progressCallback)
        {
